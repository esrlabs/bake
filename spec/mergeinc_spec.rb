...
describe "Merge-Inc" do
  ...
  it 'libs and main' do
    ...
    expect($mystring.include?("g++ -c -MD -MF build/test_main_test/src/lib2.d -IE:/bake/bake/spec/testdata/root2/lib2/build/test_main_test/mergedIncludes -o build/test_main_test/src/lib2.o src/lib2.cpp")).to be == true
