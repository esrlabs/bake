...
when "mdr_test_suppress"
  if step == "analyze"
    puts "Project path: main"
    puts "Rebuilding done."
  elsif step == "MDR"
    FileUtils::rm_rf(qacDir + "/prqa/reports/data")
    FileUtils::mkdir_p(qacDir + "/prqa/reports/data")
    File.open(qacDir + "/prqa/reports/data/1.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/a.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncA\","
      file.puts "      \"line\": 1,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
    ...
    File.open(qacDir + "/prqa/reports/data/2.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/b.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncB\","
      file.puts "      \"line\": 2,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
    ...
    File.open(qacDir + "/prqa/reports/data/3.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/c.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncC1\","
      file.puts "      \"line\": 2,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
    ...
    File.open(qacDir + "/prqa/reports/data/4.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/d.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncD1\","
      file.puts "      \"line\": 4,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
    ...
    File.open(qacDir + "/prqa/reports/data/5.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/e.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncE1\","
      file.puts "      \"line\": 3,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
    ...
    File.open(qacDir + "/prqa/reports/data/6.json", "w") do |file|
      file.puts "{"
      file.puts "  \"file\": \"src/f.cpp\","
      file.puts "  \"entities\":"
      file.puts "  ["
      file.puts "    {"
      file.puts "      \"type\": \"function\","
      file.puts "      \"name\": \"FuncF1\","
      file.puts "      \"line\": 3,"
      file.puts "      \"metrics\":"
      file.puts "      {"
      file.puts "        \"STCYC\": \"12\""
