...
describe "Merging Configs" do
  ...
  it 'build base (all)' do
    expect(File.exist?("spec/testdata/merge/main/build/testL1/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL2/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL3/libmain.a")).to be == false
    Bake.startBake("merge/main", ["testL1", "--rebuild"])
    expect(File.exist?("spec/testdata/merge/main/build/testL1/libmain.a")).to be == true
    expect(File.exist?("spec/testdata/merge/main/build/testL2/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL3/libmain.a")).to be == false
  end
  ...
  it 'build child (all)' do
    ...
    expect(File.exist?("spec/testdata/merge/main/build/testL1/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL2/libmain.a")).to be == true
    expect(File.exist?("spec/testdata/merge/main/build/testL3/libmain.a")).to be == false
  end
  ...
  it 'build grandchild (all)' do
    ...
    expect(File.exist?("spec/testdata/merge/main/build/testL1/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL2/libmain.a")).to be == false
    expect(File.exist?("spec/testdata/merge/main/build/testL3/libmain.a")).to be == true
  end
  ...
  it 'file and exclude file (child)' do
    expect(File.exist?("spec/testdata/merge/main/build/testL5/libmain.a")).to be == false
    Bake.startBake("merge/main", ["testL5", "--rebuild"])
    expect($mystring.include?("stestL5.cpp")).to be == true
    expect(File.exist?("spec/testdata/merge/main/build/testL5/libmain.a")).to be == true
  end

  it 'file and exclude file (parent)' do
    expect(File.exist?("spec/testdata/merge/main/build/testL6/libmain.a")).to be == false
    Bake.startBake("merge/main", ["testL6", "--rebuild"])
    expect($mystring.include?("stestL1.cpp")).to be == true
    expect(File.exist?("spec/testdata/merge/main/build/testL6/libmain.a")).to be == true
  end
  ...
  it 'linkerscript, artifact, map (all)' do
    if not RUBY_PLATFORM =~ /darwin/
      expect(File.exist?("spec/testdata/merge/main/build/testE3/testE3.map")).to be == false
      expect(File.exist?("spec/testdata/merge/main/build/testE3/testE3.exe")).to be == false

      Bake.startBake("merge/main", ["testE3", "--rebuild", "-v2"])

      expect($mystring.include?("linkerscript3")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE3/testE3.exe")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE3/testE3.map")).to be == true
    end
  end

  it 'linkerscript, artifact, map (child)' do
    if not RUBY_PLATFORM =~ /darwin/
      expect(File.exist?("spec/testdata/merge/main/build/testE5/testE5.map")).to be == false
      expect(File.exist?("spec/testdata/merge/main/build/testE5/testE5.exe")).to be == false

      Bake.startBake("merge/main", ["testE5", "--rebuild", "-v2"])

      expect($mystring.include?("linkerscript5")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE5/testE5.exe")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE5/testE5.map")).to be == true
    end
  end

  it 'linkerscript, artifact, map (parent)' do
    if not RUBY_PLATFORM =~ /darwin/
      expect(File.exist?("spec/testdata/merge/main/build/testE6/testE1.exe")).to be == false
      expect(File.exist?("spec/testdata/merge/main/build/testE6/testE1.map")).to be == false

      Bake.startBake("merge/main", ["testE6", "--rebuild", "-v2"])

      expect($mystring.include?("linkerscript1")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE6/testE1.exe")).to be == true
      expect(File.exist?("spec/testdata/merge/main/build/testE6/testE1.map")).to be == true
    end
  end

  it 'parent broken' do
    expect(File.exist?("spec/testdata/merge/main/build/testE6/testE6.exe")).to be == false
  ...
  it 'var subst' do
    ...
    if !(Bake.ciRunning? && Bake::Utils::OS.name == "Mac")
      expect(File.exist?("spec/testdata/merge/main/build/testE6/testE1.map")).to be == true # subst
    end
  end
