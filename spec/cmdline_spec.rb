...
describe "Cmdline" do
  ...
  it 'works' do
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_ok/main.exe.cmdline")).to be == false
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_ok/main.exe.cmdline")).to be == true
    ...
    expect(contents.strip).to be == "ar -rc build/test_ok_main_test_ok/liblib.a build/test_ok_main_test_ok/src/y.o"
    ...
    contents = File.read("spec/testdata/simple/main/build/test_ok/main.exe.cmdline")  
    expect(contents.strip).to be == "g++ -o build/test_ok/main.exe build/test_ok/src/x.o ../lib/build/test_ok_main_test_ok/liblib.a"
  end
  ...
  it 'compile error' do
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_compileError/main.exe.cmdline")).to be == false
  ...
  it 'archive error' do
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_archiveError/main.exe.cmdline")).to be == false
    ...
    expect(contents.strip).to be == "ar -wrong -rc build/test_ok_main_test_archiveError/liblib.a build/test_ok_main_test_archiveError/src/y.o"
  end
  ...
  it 'link error' do
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_linkError/main.exe.cmdline")).to be == false
    ...
    expect(File.exists?("spec/testdata/simple/main/build/test_linkError/main.exe.cmdline")).to be == true

    contents = File.read("spec/testdata/simple/main/build/test_linkError/main.exe.cmdline")  
    expect(contents.strip).to be == "g++ -wrong -o build/test_linkError/main.exe build/test_linkError/src/x.o ../lib/build/test_ok_main_test_linkError/liblib.a"
  end  
