...
describe "Multiple root" do
  ...
  it 'single root' do
    expect(File.exists?("spec/testdata/root1/main/build/test/main.exe")).to be == false
  ...
  it 'both roots' do
    ...
    expect(File.exists?("spec/testdata/root1/main/build/test/main.exe")).to be == true
  end
  ...
  it 'auto root overwritten wrong' do
    expect(File.exists?("spec/testdata/root1/mainAutoRoot/build/test/mainAutoRoot.exe")).to be == false
  ...
  it 'auto root overwritten right' do
    ...
    expect(File.exists?("spec/testdata/root1/mainAutoRoot/build/test/mainAutoRoot.exe")).to be == true
  end
