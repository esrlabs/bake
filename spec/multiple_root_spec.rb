...
describe "Multiple root" do
  ...
  it 'auto root overwritten wrong' do
    expect(File.exists?("spec/testdata/root1/mainAutoRoot/test/mainAutoRoot.exe")).to be == false
  ...
  it 'auto root overwritten right' do
    ...
    expect(File.exists?("spec/testdata/root1/mainAutoRoot/test/mainAutoRoot.exe")).to be == true
  end  
